...
namespace Paniq.Tests.EditMode
{
    ...
    /// </para>
    /// </summary>
    public sealed class FireReactionTraitCardsEditModeTests
    {
        ...
        public void AThrow_CatchesEverybodyInsideThePatchAndNobodyOutsideIt()
        {
            ...
            using (var simulation = new FireReactionSimulation(data))
            {
                ...
                Assert.That(EventsOfType(simulation, FireReactionEventType.PowerCourage).Count, Is.EqualTo(2),
        ...
        public void AThrowThatCatchesSomebodyAlreadyAtThatEnd_StillCountsIfItMovedAnybody()
        {
            ...
            FireReactionScenarioData data = QuietRoomWith(new LogicalPosition(0, 0), new LogicalPosition(700, 0));
            ...
            using (var simulation = new FireReactionSimulation(data))
            {
                ...
                Assert.That(EventsOfType(simulation, FireReactionEventType.PowerCourage).Count, Is.EqualTo(1),
        ...
        public void AThrow_DoesNotReachTheDead()
        {
            ...
            using (var simulation = new FireReactionSimulation(data))
            {
                ...
                Assert.That(EventsOfType(simulation, FireReactionEventType.PowerCourage), Is.Empty,
