...
namespace Paniq.Tests.EditMode
{
    ...
    /// </summary>
    public sealed class FarRoomsEditModeTests
    {
        ...
        private WorldGeometry TwoRoomsFarApart()
        {
            ...
            data.Rooms = new[]
            {
                ...
                new RoomDefinition(FarRoom, new LogicalBounds(6000, 26000, -6000, 6000))
            };
            data.Doors = new[]
            {
                new DoorDefinition(BetweenThem, NearRoom, WallSide.East, 0, 1000, false)
            };
