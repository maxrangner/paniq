...
namespace Paniq.Tests.EditMode
{
    ...
    /// in the flames.
    /// </summary>
    public sealed class FireReactionOfficeItemsEditModeTests
    {
        ...
        private FireReactionScenarioData OneThing(PhysicsObjectKind kind, int sizeMillimetres, int massGrams)
        {
            ...
            {
                new FireReactionPhysicsObjectDefinition(new SimulationId(3001UL), kind, new LogicalPosition(-4000, 0),
        ...
        {
            FireReactionScenarioData data = OneThing(kind, 400, 5000);
        ...
        {
            FireReactionScenarioData data = OneThing(PhysicsObjectKind.PottedPlant, 450, 25000);
            ...
            FireReactionPhysicsObjectSnapshot plant = simulation.GetPhysicsObject(0);
