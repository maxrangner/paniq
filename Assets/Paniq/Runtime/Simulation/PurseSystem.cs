namespace Paniq.Simulation
{
    ...
    /// </para>
    /// <para>
    /// The purse is bookkeeping rather than something that happens in the
    ...
    /// log still accounts for where the purse went.
    /// </para>
    /// </summary>
    ...
    internal sealed class PurseSystem
    {
        private readonly PurseSettings settings;
        private readonly SimulationContext context;
        private int eventsRead;

        public PurseSystem(SimulationContext context)
        {
            this.context = context;
            settings = context.Scenario.Purse;
            Purse = settings.Starting;
        }
        ...
        /// <summary>
        /// Whether there is a purse at all (<see cref="PurseSettings.Enabled"/>).
        ...
        public bool CanAfford(PlayerCommandType card) => Purse >= CostOf(card);

        public bool CanAfford(int cost) => Purse >= cost;
        ...
        internal static UproarTier UproarTierOf(CausalEventType what)
        {
            switch (what)
            {
                ...
                // building settling. What it sets off -- a bin catching, a
                // bang -- is paid for by those events, above.
        ...
        /// <summary>
        /// Puts points in the purse for a test whose subject is something
        ...
        private void Credit(int amount)
        {
            ...
            int before = Purse;
            Purse = System.Math.Min(settings.Maximum, Purse + amount);
            Earned += Purse - before;
        }
    }
}
