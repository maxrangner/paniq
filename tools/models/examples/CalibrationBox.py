...
deformation that squashes it. ModelsEditModeTests loads the exported file
in Unity and checks that the box is a metre across, that the bumps sit on
+Y (up), +X (the way people face) and +Z (the model's right), that the
flap's pivot is on the hinge, that the deformation arrived as a blend
shape, and that nothing carries a stray rotation or scale. If a Blender or
...
def build():
    ...
    m.box("FrontBump", size=(0.2, 0.1, 0.2), at=(0.0, -0.55, 0.4))
