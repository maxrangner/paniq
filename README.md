...
Assets/Paniq/
  ...
  Content/       Placeholder and future game content; built models under Content/Models
  Tests/         Edit-mode and play-mode tests
  Scenes/        Bootstrap and development scenes
docs/            Vision, goals, decisions, and workflow; model previews under docs/models
tools/           Scripts that drive Unity and Blender from outside the editor
```
