...
namespace Paniq.Tests.EditMode
{
    ...
    /// </para>
    /// </summary>
    public sealed class FireReactionDoorBurnEditModeTests
    {
        ...
        private static FireReactionDoorSnapshot DoorOf(FireReactionSimulation simulation, SimulationId door)
        {
        ...
        {
            FireReactionScenarioData data = FireAgainstTheClosetDoor();
            ...
            using (var simulation = new FireReactionSimulation(data))
            {
                ...
                FireReactionDoorSnapshot charring = DoorOf(simulation, ClosetDoor);
        ...
        public void ADoorThatBurnsThrough_IsWrittenDownWithTheFireAsItsCause()
        {
            ...
            using (var simulation = new FireReactionSimulation(data))
            {
                ...
                {
                    if (record.EventType == FireReactionEventType.DoorBurntThrough)
                    {
                        burnt = record;
                        found = true;
                    }
                ...
                FireReactionEventType cause = simulation.EventLog.Get(burnt.CausalParentEventId).EventType;
                Assert.That(cause == FireReactionEventType.FireActivated || cause == FireReactionEventType.FireSpread,
        ...
        public void AnOpenDoor_NeverChars()
        {
            ...
            using (var simulation = new FireReactionSimulation(data))
            {
                ...
                FireReactionDoorSnapshot door = DoorOf(simulation, ClosetDoor);
        ...
        public void ADoorAcrossTheBuilding_IsLeftAlone()
        {
            ...
            using (var simulation = new FireReactionSimulation(data))
            {
                ...
                FireReactionDoorSnapshot far = DoorOf(simulation, new SimulationId(2008UL));
        ...
        /// </summary>
        private static FireReactionRoomDefinition[] ClosetFirst(FireReactionRoomDefinition[] rooms)
        {
            var reordered = new FireReactionRoomDefinition[rooms.Length];
            int next = 1;
        ...
        private static bool BurningInTheOffice(FireReactionSimulation simulation)
        {
