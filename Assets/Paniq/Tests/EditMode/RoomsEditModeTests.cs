...
namespace Paniq.Tests.EditMode
{
    ...
    /// </summary>
    public sealed class RoomsEditModeTests
    {
        ...
        private static void OpenClosetDoor(Run simulation, int tick)
        {
        ...
        private static bool OutOfTheOffice(ScenarioData data, LogicalPosition point)
        {
        ...
        private static bool InCloset(ScenarioData data, LogicalPosition point)
        {
        ...
        private ScenarioData FireAtTheEastDoor()
        {
        ...
        private static int BurningInCloset(Run simulation, ScenarioData data)
        {
            int count = 0;
        ...
        /// DoorBurnEditModeTests' business; this is about the door
        /// holding while it holds.
        /// </summary>
        [Test]
        public void Fire_DoesNotGetThroughAClosedDoorWhileItHolds()
        {
            ScenarioData data = FireAtTheEastDoor();
        ...
        public void Runner_WithNoWayOut_RunsToTheRoomFurthestFromTheFire()
        {
            ...
            data.Agents = new[]
            {
                new AgentDefinition(new SimulationId(1UL), new LogicalPosition(4500, 2500), CardinalDirection.West,
        ...
        public void ClosedDoor_HidesTheFireAndMufflesYells()
        {
            ...
            data.Agents = new[]
            {
                new AgentDefinition(new SimulationId(1UL), new LogicalPosition(6500, 2000), CardinalDirection.West),
            ...
            AgentSnapshot inside = simulation.GetAgent(0);
        ...
        {
            const int stuckLimitTicks = 5 * Run.TicksPerSecond;
            for (ulong seed = 1UL; seed <= 10UL; seed++)
            {
                ...
                for (int i = 0; i < simulation.AgentCount; i++)
                {
                    Assert.That(stillFor[i], Is.LessThan(2 * Run.TicksPerSecond),
        ...
        internal static bool NearAnOpenDoor(Run simulation, LogicalPosition position)
        {
